...
def main():
    ...
    for i, img_path in enumerate(img_list):
        ...
        print(os.path.join(folder_Gen, base_name + suffix + '.png'))
    ...
    print(Mean_format.format(data_name, Mean_PSNR, Mean_SSIM))

    PS_txt.write(Mean_format.format(data_name, Mean_PSNR, Mean_SSIM))
    PS_txt.write('\n')
